...
public class GeneralCheckingFunctions {
    public static boolean check3DMaze(){
        ...
        // Note, that if this will be false, you will automatically get minus 10
        // in the score of the first part of the project.
    ...
    public static String getGithubLink(){
        ...
        String githubLink = "https://github.com/adimarom96/ATP-Project-PartA";
        return githubLink;
    }
}